...
let test_integral _ =
  assert_less (mathemadiga (INTEGRAL (REAL 1.0, REAL 2.0, INT 1))) 1.0 0.1;
  assert_less (mathemadiga (INTEGRAL (REAL 1.0, REAL 2.0, X))) 1.5 0.1;
  assert_less (mathemadiga (INTEGRAL (REAL 2.0, REAL 1.0, X))) (-1.5) 0.1;
  assert_less (mathemadiga (INTEGRAL (REAL 2.0, REAL 2.0, X))) 0.0 0.1
